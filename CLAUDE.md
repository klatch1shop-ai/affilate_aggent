...
Поточне покриття (оновлено 2026-06-07):
- Змаппованих категорій: 1790 з 5124 (+347 новий + пропагація)
- Покриття товарів: ~45% (3316 з 7417 в наявності)
- Незмаппованих: ~55% (4101 товарів у DEFAULT "Ручний інструмент" 25636737)

ВИПРАВЛЕНО: Витяжки були 80192 (Обігрівачі!) → правильно 80140
ВИПРАВЛЕНО: Мультипечі були 112986 (Мультиварки!) → правильно 81089

Підтверджені (перевірені через URL bt.rozetka.com.ua/c{id}/):
...
Плити(80137,7.56), Витяжки(80140,14.04), Праски(80161,19.44),
Пилосос(80158,19.44), Електрочайники(80160,19.44), Фени(81231,19.44),
Кавоварки(4674720,19.44), Мультипечі(81089,19.44), Мультиварки(112986,19.44),
Зубні щітки(437994,19.44), Телевізори(80011,12.96), Павербанки(4638591,19.44),
Батарейки(80255,19.44), Кріплення для ТВ(80071,23.76), Аксесуари ноутбук(80090,23.76),
Мікрохвильові печі(80162,14.04), М'ясорубки(80176,19.44), Тостери(80145,19.44),
Тримери(4660433,19.44), Електробритви(81226,19.44), Вирівнювачі волосся(4675058,19.44),
Обігрівачі(80192,14.04), Роботи-пилосос(237815,19.44), Вентилятори(80186,14.04),
Міксери(80156,19.44), Хлібопічки(80154,19.44), Сушарки овочів(80697,19.44),
Машинки стрижки(81229,19.44), Епілятори(81225,19.44)
...
- Залишок незмаппованих IT-категорій (~55% = 4101 товарів у DEFAULT):
  Підтвердити в PriceCreator або через URL bt.rozetka.com.ua/c{id}/:
  Смартфони, Планшети, Мікрофони, Відеореєстратори, Веб-камери,
  Кабелі(80329), USB(80333), Картриджі(80296), Корпуси ПК(80038),
  Кулери(80049), Чорнила(73126), Чохли(4638562), Захисні плівки(4638563),
  LED лампи(4638153), Світильники(4638228), ЗП мобільні(4638593),
  USB Hub(80339), Килимки(80097), Контролери PCI(80052)
- Логін/пароль Розетки в .env неправильні (hyper_store/Tovarka2025Rivne → помилка incorrect_username_password)
  Потрібно оновити пароль або дізнатись актуальний через seller.rozetka.com.ua
