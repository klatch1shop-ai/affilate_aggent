...
## ⛔ Rozetka: після відправки на модерацію зміст фіду не змінюється

Власник 19.09.2026: товари, відправлені на модерацію, **не змінювати**. Довідка
Rozetka (p202): зміна назви, фото, опису, характеристик потребує повторної
модерації. Тому після подачі змінюються **лише ціна й наявність** — для NOIRE,
TOPTUL, dropoffice, Carvol і кожного нового фіду. Відмови — зібрати, доповісти,
виправити в генераторі для наступних фідів; правити відхилені — лише за
рішенням власника.

**Отже, все перевіряється ДО подачі** — гейти й інструменти в
`.claude/skills/skill-36-rozetka-new-feed/SKILL.md` (фото —
`tools/rozetka_photo_audit.py`, стан після подачі — `tools/rozetka_source_status.py`).
