...
Джерело нових фраз — prom_kw_matrix.build() з вимкненим шаром 3
(DESC_BIGRAMS = False): біграми з опису пропускали склейки на кшталт
«лубрикантом водній» через зламаний _is_adj.
