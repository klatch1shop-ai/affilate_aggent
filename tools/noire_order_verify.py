...
def main():
    ...
    if t:
        ...
        if paid is True:
            ...
            # власник 15.09: «післяплата моя робота і не зважай на це поки» — лише інформація
            put('ℹ️', 'НП: післяплата', f'0 грн, клієнт платить при отриманні {amount} грн — додає власник')
        else:
