...
# 1.10 дає простір для акцій: при 1.0 ціна стоїть рівно на беззбитковості,
# і будь-яка знижка порушує правило SexOpt про мінімальну ціну.
MARKUP = float(os.getenv('NOIRE_MARKUP_ROZETKA', '1.10'))
