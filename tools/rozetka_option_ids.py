...
# усі є фільтрами й усі в нас порожні. Перші дві — 25.08.2026, решта
# чотири — 01.09.2026, за вагою відсутніх фільтрів (`Вид` 2033 оффери,
# `Особливості` 1925, `Робочий розмір` 1778, `Тип` 738).
DEFAULT_NAMES = ('Розмір посадкового квадрата', 'Кількість граней',
                 'Робочий розмір', 'Вид', 'Тип', 'Особливості')
