---
name: "rozetka"
description: "Rozetka: перевірки демонів, публікація фідів, валідація XML, ТТН. Довідкові файли поруч: SKILL-29-moderation-rejections — розбір причин відхилення карток модерацією; SKILL-30-rozetka-search — пошук по Rozetka без токена: конкуренти за артикулом, їхні ціни, вибір категорії."
---
